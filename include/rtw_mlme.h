...
#define LINK_MLME_STATE(adapter_link) MLME_STATE((adapter_link)->adapter) /* this driver has only one adapter link */
#define CHK_MLME_STATE(adapter, state) check_fwstate(&((adapter)->mlmepriv), (state))
#define CHK_LINK_MLME_STATE(adapter_link, state) CHK_MLME_STATE((adapter_link)->adapter, (state)) /* this driver has only one adapter link */
