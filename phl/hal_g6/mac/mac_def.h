...
/**
 * @struct mac_ax_wow_diag_rpt
 * @brief Structure to store wow diagnostic repoert from FW
 *
 * @var mac_ax_wow_diag_rpt::tsf_h
 * Higher part of TSF when WoWlan starts.
 * @var mac_ax_wow_diag_rpt::tsf_l
 * Lower part of TSF when WoWlan ends.
 * @var mac_ax_wow_diag_rpt::err_code
 ...
 */
struct mac_wow_diag_info {
#define WOW_DIAG_MAX 0x0E
#define	WOW_DIAG_C2H_IDLE 0
#define	WOW_DIAG_C2H_WAITING 1
#define WOW_DIAG_C2H_DONE 2
#define WOW_DIAG_C2H_FAIL 3
	u8 diag_c2h_sm[WOW_DIAG_MAX];
	...
	u32 evt_dack;
#define WOW_TRI_EVT_MAX 0x04
	u8 evt_c2h_sm[WOW_TRI_EVT_MAX];
