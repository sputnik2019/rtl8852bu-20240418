...
#define REGULATION_CHPLAN_VERSION 65
#define REGULATION_COUNTRY_VERSION 44
...
static const struct chdef_5ghz chdef5g[] = {
    ...
    {41, 0x0f, 0x00, 0x00, 0x0f, 0x00, 0x0f, {0xff, 0x03}, {0x00, 0x00}, {0xff, 0x07}, 0x1e, 0x1f, 0x00},
...
const struct country_domain_mapping cdmap[] = {
    ...
    {0x76, 0x06, {'T', 'W'}, TPO_NA, 0x0f, 0, 0x05, 0}, /* 0098 */
    ...
    {0x10, 0x07, {'C', 'A'}, TPO_NA, 0x0f, 0, 0x03, 0}, /* 0104 */
    ...
    {0x5e, 0x00, {'L', 'Y'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0179 */
    ...
    {0x76, 0x00, {'M', 'H'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0185 */
    ...
    {0x76, 0x00, {'F', 'M'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0190 */
    ...
    {0x76, 0x00, {'M', 'P'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0200 */
    {0x76, 0x00, {'P', 'W'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0201 */
    ...
    {0x76, 0x00, {'M', 'F'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0207 */
    {0x76, 0x00, {'S', 'X'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0208 */
    {0x5e, 0x00, {'P', 'M'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0209 */
    {0x76, 0x00, {'V', 'C'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0210 */
    {0x76, 0x00, {'W', 'S'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0211 */
    ...
    {0x3a, 0x00, {'S', 'B'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0216 */
    {0x3a, 0x00, {'S', 'O'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0217 */
    ...
    {0x3a, 0x00, {'T', 'O'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0226 */
    {0x3a, 0x00, {'T', 'M'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0227 */
    {0x3a, 0x00, {'T', 'C'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0228 */
    {0x21, 0x00, {'T', 'V'}, TPO_NA, 0x01, 0, 0x00, 0}, /* 0229 */
    {0x3a, 0x00, {'U', 'G'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0230 */
    {0x76, 0x00, {'V', 'I'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0231 */
    ...
    {0x3a, 0x00, {'I', 'R'}, TPO_NA, 0x01, 0, 0x00, 0}, /* 0237 */
